...
describe('StructuredLogger', () => {
  ...
  describe('Secret Redaction', () => {
    ...
    it('should redact GitHub OAuth tokens', async () => {
      ...
      logger.info('Using token gho_1234567890abcdefghijklmnopqrstuvwxyz');
      await logger.flush();
    ...
    it('should redact authorization headers', async () => {
      ...
      logger.info('Sending request', {
        headers: { Authorization: 'Bearer ghp_secrettoken1234567890abcdefghijklmnopqrstuv' },
      });
      await logger.flush();
  ...
  describe('RedactionEngine', () => {
    ...
    it('should redact secrets in nested objects', () => {
      ...
      const input = {
        ...
        data: ['ghp_1234567890abcdefghijklmnopqrstuvwxyz', 'normal-value'],
      };
